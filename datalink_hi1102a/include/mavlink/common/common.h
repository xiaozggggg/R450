...
typedef enum MAV_TYPE
{
   ...
   MAV_TYPE_WKGCS=34, /* Walkera GroundStation | */
...
typedef enum MAV_STATE
{
   ...
   MAV_STATE_LAND_COMPLETE=9, /* System is land complete | */
   MAV_STATE_THROW_ENABLE=10, /* System's throw function enable | */
   MAV_STATE_ENUM_END=11, /*  | */
} MAV_STATE;
#endif
...
typedef enum MAV_SYS_STATUS_SENSOR
{
   ...
   MAV_SYS_STATUS_SENSOR_GPS2=268435456, /* 0x10000000 GPS2 | */
   MAV_SYS_STATUS_SENSOR_RTK=536870912, /* 0x20000000 RTK | */
