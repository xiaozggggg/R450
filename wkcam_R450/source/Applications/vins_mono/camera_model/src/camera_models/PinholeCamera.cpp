...
PinholeCamera::Parameters::readFromYamlFile(const std::string& filename)
{
    ...
    double factor =  static_cast<double>(fs["factor"]);

    m_imageWidth = static_cast<int>(fs["image_width"]) * factor;
    m_imageHeight = static_cast<int>(fs["image_height"]) * factor;
    ...
    m_fx = static_cast<double>(n["fx"]) * factor;
    m_fy = static_cast<double>(n["fy"]) * factor;
    m_cx = static_cast<double>(n["cx"]) * factor;
    m_cy = static_cast<double>(n["cy"]) * factor;
