...
#include "VIOTimestamp.h"

using namespace std;

using namespace DUtils;

DUtils::Timestamp::Timestamp(DUtils::Timestamp::tOptions option)
{
...
DUtils::Timestamp::~Timestamp(void)
{
}

bool DUtils::Timestamp::empty() const
{
  return m_secs == 0 && m_usecs == 0;
}

void DUtils::Timestamp::setToCurrentTime(){
...
void DUtils::Timestamp::setTime(const string &stime){
...
void DUtils::Timestamp::setTime(double s)
{
  m_secs = (unsigned long)s;
  m_usecs = (s - (double)m_secs) * 1e6;
}

double DUtils::Timestamp::getFloatTime() const {
	return double(m_secs) + double(m_usecs)/1000000.0;
}

string DUtils::Timestamp::getStringTime() const {
	char buf[32];
	sprintf(buf, "%.6lf", this->getFloatTime());
	return string(buf);
}

double DUtils::Timestamp::operator- (const DUtils::Timestamp &t) const {
	return this->getFloatTime() - t.getFloatTime();
}

DUtils::Timestamp& DUtils::Timestamp::operator+= (double s)
{
  *this = *this + s;
  return *this;
}
...
DUtils::Timestamp DUtils::Timestamp::operator+ (double s) const
{
...
DUtils::Timestamp DUtils::Timestamp::plus(unsigned long secs, unsigned long usecs) const
{
    DUtils::Timestamp t;
...
DUtils::Timestamp DUtils::Timestamp::minus(unsigned long secs, unsigned long usecs) const
{
  DUtils::Timestamp t;
...
bool DUtils::Timestamp::operator> (const DUtils::Timestamp &t) const
{
...
string DUtils::Timestamp::Format(bool machine_friendly) const 
{
  struct tm tm_time;
...
string DUtils::Timestamp::Format(double s) {
