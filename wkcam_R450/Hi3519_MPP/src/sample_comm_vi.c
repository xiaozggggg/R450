...
#define WIDTH_4000 4000
#define HEIGHT_3000 3000
...
#define IMX378_OB_HEIGHT_END 0
#define IMX582_OB_HEIGHT_END 0
#define XC9080_OB_HEIGHT_END 0
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx347_slave_12bit_4m_nowdr_dev2_attr = {
    ...
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 2, WIDTH_2688, HEIGHT_1520},
    .mipi_attr  = {
        DATA_TYPE_RAW_12BIT,
        OT_MIPI_WDR_MODE_NONE,
        {4, 5, 6, 7, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx378_10bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_3840, HEIGHT_2160},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx378_10bit_2m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx582_10bit_8m_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_3840, HEIGHT_2160},
...
static combo_dev_attr_t g_mipi_4lane_chn0_sensor_imx582_10bit_3000p_nowdr_attr = {
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_4000, HEIGHT_3000},
    .mipi_attr = {
        DATA_TYPE_RAW_10BIT,
        OT_MIPI_WDR_MODE_NONE,
        {0, 1, 2, 3, -1, -1, -1, -1}
...
static combo_dev_attr_t g_mipi_2lane_chn3_sensor_xc9080_10bit_8m_nowdr_attr = {
    .devno = 3,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, WIDTH_1280, HEIGHT_480},
    .mipi_attr = {
...
static combo_dev_attr_t g_mipi_2lane_chn2_sensor_xc9080_10bit_8m_nowdr_attr = {
    .devno = 2,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
    .img_rect = {0, 0, WIDTH_1280, HEIGHT_480},
...
static td_void sample_comm_vi_get_mipi_attr(sample_sns_type sns_type, combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
		...
		case SONY_IMX378_MIPI_8M_30FPS_10BIT:   //add by Kyrie
            ob_height = IMX378_OB_HEIGHT_END;
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx378_10bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
        ...
        case SONY_IMX582_MIPI_8M_30FPS_10BIT:   //add by Kyrie
            ...
            (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                &g_mipi_4lane_chn0_sensor_imx582_10bit_8m_nowdr_attr, sizeof(combo_dev_attr_t));
            break;
                                                      ...
                                                      combo_dev_attr_t *combo_attr)
{
    ...
    switch (sns_type) {
        ...
        case SONY_IMX378_MIPI_2M_60FPS_10BIT:   //add by Kyrie
            ...
            if (vi_dev == 0) {
                (td_void)memcpy_s(combo_attr, sizeof(combo_dev_attr_t),
                    &g_mipi_4lane_chn0_sensor_imx378_10bit_2m_nowdr_attr, sizeof(combo_dev_attr_t));
            }
            break;
...
static ot_vi_dev_attr g_mipi_yuv422_dev_attr = {
    ...
    /* mask component */
    .component_mask = {0xff000000, 0xff0000},
...
static td_void sample_comm_vi_get_dev_attr_by_intf_mode(ot_vi_intf_mode intf_mode, ot_vi_dev_attr *dev_attr)
{
    switch (intf_mode) {
        case OT_VI_INTF_MODE_MIPI:
            ...
            break;
        case OT_VI_INTF_MODE_MIPI_YUV422:
            (td_void) memcpy_s(dev_attr, sizeof(ot_vi_dev_attr), &g_mipi_yuv422_dev_attr, sizeof(ot_vi_dev_attr));
            break;
...
td_void sample_comm_vi_get_size_by_sns_type(sample_sns_type sns_type, ot_size *size)
{
    switch (sns_type) {
        ...
        case SONY_IMX582_MIPI_3000P_30FPS_10BIT:
            size->width  = WIDTH_4000;
            size->height = HEIGHT_3000;
            break;

        case OV_XC9080_MIPI_8M_30FPS_10BIT:
...
td_void sample_comm_vi_get_default_dev_info(sample_sns_type sns_type, sample_vi_dev_info *dev_info)
{
    ...
    dev_info->vi_dev = 0;
    //add by Kyrie
    if (sns_type == OV_XC9080_MIPI_8M_30FPS_10BIT) {
        sample_comm_vi_get_dev_attr_by_intf_mode(OT_VI_INTF_MODE_MIPI_YUV422, &dev_info->dev_attr);
    } else { 
    ...
    if (sns_type == GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT) {
        ...
        dev_info->dev_attr.component_mask[0] = 0xfff00000;
    }
}
...
static td_s32 sample_comm_vi_start_chn(ot_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    td_u32 i;
    td_s32 ret;
    td_s32 chn_num = pipe_info->chn_num;
...
td_u32 sample_comm_vi_get_raw_stride(ot_pixel_format pixel_format, td_u32 width, td_u32 byte_align, td_u32 align)
{
    ...
    if (pixel_format == OT_PIXEL_FORMAT_RGB_BAYER_16BPP) {
        ...
        if (byte_align == 1) {
            ...
            stride = (width * 14) / 8; // raw14 (width * 14) / 8;
        ...
        if (byte_align == 1) {
            ...
            stride = (width * 12) / 8; // raw12 (width * 12) / 8;
