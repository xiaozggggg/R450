 ...
 * function :mpi_init
 */
static td_s32 sample_common_ive_mpi_init(td_void)
{
    td_s32 ret;
...
td_s32 sample_common_ive_read_file(ot_svp_img *img, FILE *fp)
{
    ...
    sample_svp_check_exps_return(img == TD_NULL, ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "img can't be null\n");
    sample_svp_check_exps_return(fp == TD_NULL, ret, SAMPLE_SVP_ERR_LEVEL_ERROR, "fp can't be null\n");
...
td_u32 sample_common_ive_calc_stride(td_u32 width, td_u8 align)
{
    ...
    sample_svp_check_exps_return((width > OT_SAMPLE_IVE_MAX_WIDTH) || (width < 1), OT_ERR_IVE_ILLEGAL_PARAM,
        SAMPLE_SVP_ERR_LEVEL_ERROR, "width(%u) must be in [1, %u]", width, OT_SAMPLE_IVE_MAX_WIDTH);
...
static td_s32 sample_common_ive_check_src_dst(ot_sample_src_dst_size *src_dst_size)
{
    sample_svp_check_exps_return((td_float)src_dst_size->src.width == 0, OT_ERR_IVE_ILLEGAL_PARAM,
        SAMPLE_SVP_ERR_LEVEL_ERROR, "src width can't be 0\n");
    sample_svp_check_exps_return((td_float)src_dst_size->src.height == 0, OT_ERR_IVE_ILLEGAL_PARAM,
        SAMPLE_SVP_ERR_LEVEL_ERROR, "src height can't be 0\n");
    sample_svp_check_exps_return((td_float)src_dst_size->dst.width == 0, OT_ERR_IVE_ILLEGAL_PARAM,
        SAMPLE_SVP_ERR_LEVEL_ERROR, "dst width can't be 0\n");
    sample_svp_check_exps_return((td_float)src_dst_size->dst.height == 0, OT_ERR_IVE_ILLEGAL_PARAM,
    ...
    td_u16 rect_max_num, td_u16 area_thr_step, ot_sample_src_dst_size *src_dst_size)
{
    ...
    sample_svp_check_failed_return(ret, OT_ERR_IVE_ILLEGAL_PARAM, SAMPLE_SVP_ERR_LEVEL_ERROR,
    ...
    td_u32 width, td_u32 height, td_bool is_mmz_cached)
{
    ...
    sample_svp_check_exps_return(height > OT_SAMPLE_IVE_MAX_HEIGHT, ret, SAMPLE_SVP_ERR_LEVEL_ERROR,
        "height(%u) must be in [1, %u]!\n", height, OT_SAMPLE_IVE_MAX_HEIGHT);
