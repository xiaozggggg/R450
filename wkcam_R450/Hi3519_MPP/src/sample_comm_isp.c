...
static ot_isp_pub_attr g_isp_pub_attr_imx378_mipi_8m_30fps = {
    {0, 0, 3840, 2160},
    {3840, 2160},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx378_mipi_2m_60fps = {
    {0, 0, 1920, 1080},
    {1920, 1080},
    60,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx582_mipi_8m_30fps = {
    {0, 0, 3840, 2160},
    {3840, 2160},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_imx582_mipi_3000p_30fps = {
    {0, 0, 4000, 3000},
    {4000, 3000},
    25,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_xc9080_mipi_8m_30fps = {
    {0, 0, 1280, 480},
    {1280, 480},
    30,
    OT_ISP_BAYER_RGGB,
...
static ot_isp_pub_attr g_isp_pub_attr_ov7251_mipi_480p_20fps = {
    {0, 0, 640, 480},
    {640, 480},
    20,
    OT_ISP_BAYER_RGGB,
...
td_s32 sample_comm_isp_get_pub_attr_by_sns(sample_sns_type sns_type, ot_isp_pub_attr *pub_attr)
{
    switch (sns_type) {
        ...
        case SONY_IMX378_MIPI_8M_30FPS_10BIT:   //add by Kyrie
            (td_void) memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx378_mipi_8m_30fps, sizeof(ot_isp_pub_attr));
            break;

        case SONY_IMX378_MIPI_2M_60FPS_10BIT:
            (td_void) memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                    &g_isp_pub_attr_imx378_mipi_2m_60fps, sizeof(ot_isp_pub_attr));
            break;

        case SONY_IMX582_MIPI_8M_30FPS_10BIT:   //add by Kyrie
            (td_void) memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx582_mipi_8m_30fps, sizeof(ot_isp_pub_attr));
            break;

        case SONY_IMX582_MIPI_3000P_30FPS_10BIT: // add by Kyrie
            (td_void) memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_imx582_mipi_3000p_30fps, sizeof(ot_isp_pub_attr));
            break;            
        ...
        case OV7251_MIPI_480P_20FPS_10BIT:
            (td_void) memcpy_s(pub_attr, sizeof(ot_isp_pub_attr),
                &g_isp_pub_attr_ov7251_mipi_480p_20fps, sizeof(ot_isp_pub_attr));
            break;
