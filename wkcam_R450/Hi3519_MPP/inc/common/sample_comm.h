...
typedef enum {
    ...
    SONY_IMX378_MIPI_8M_30FPS_10BIT,    //add by Kyrie
    SONY_IMX378_MIPI_2M_60FPS_10BIT,
    OV_XC9080_MIPI_8M_30FPS_10BIT,      //add by Kyrie
    SONY_IMX582_MIPI_8M_30FPS_10BIT,    //add by Kyrie
    SONY_IMX582_MIPI_3000P_30FPS_10BIT, //add by Kyrie
...
typedef struct {
    ...
    td_bool save_heif;
    // walkera
    int (*PreviewCallback)(unsigned char *pBuf, int length, WK_FRAME_FLAG_E FrameFlag);
    int (*RecordCallback)(unsigned char *pBuf, int length);
...
td_s32 sample_comm_audio_creat_thread_ai_ao(ot_audio_dev ai_dev, ot_ai_chn ai_chn,
    ot_audio_dev ao_dev, ot_ao_chn ao_chn);
td_s32 sample_comm_audio_creat_thread_ai_aenc(ot_audio_dev ai_dev, ot_ai_chn ai_chn, ot_aenc_chn ae_chn);
td_s32 sample_comm_audio_creat_thread_aenc_adec(ot_aenc_chn ae_chn, ot_adec_chn ad_chn, FILE *aenc_fd);
td_s32 sample_comm_audio_creat_thread_file_adec(ot_adec_chn ad_chn, FILE *adec_fd);
td_s32 sample_comm_audio_creat_thread_ao_vol_ctrl(ot_audio_dev ao_dev);
td_s32 sample_comm_audio_destory_thread_ai(ot_audio_dev ai_dev, ot_ai_chn ai_chn);
td_s32 sample_comm_audio_destory_thread_aenc_adec(ot_aenc_chn ae_chn);
td_s32 sample_comm_audio_destory_thread_file_adec(ot_adec_chn ad_chn);
td_s32 sample_comm_audio_destory_thread_ao_vol_ctrl(ot_audio_dev ao_dev);
td_s32 sample_comm_audio_destory_all_thread(td_void);
...
void WK_COMM_VENC_GetRecordStreamTest(int option);
