...
#define OT_SVP_COORDS_NUM                       64
#define OT_COORDS_POINT_NUM                     2
...
typedef struct {
    td_float point[OT_COORDS_POINT_NUM];
} ot_sample_svp_coords;

typedef struct {
    td_u16 num;
    ot_sample_svp_coords coords[OT_SVP_RECT_NUM];
} ot_sample_svp_coords_info;
