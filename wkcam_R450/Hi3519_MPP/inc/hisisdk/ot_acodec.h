...
#define OT_ACODEC_SET_I2S1_DATA_WIDTH \
    _IOWR(IOC_TYPE_ACODEC, IOC_NR_SET_I2S1_DATA_WIDTH, td_u32)
...
/* query status, 1:enable, 0:disable */
#define OT_ACODEC_QUERY_STATUS \
    _IOWR(IOC_TYPE_ACODEC, IOC_NR_QUERY_STATUS, td_u32)
