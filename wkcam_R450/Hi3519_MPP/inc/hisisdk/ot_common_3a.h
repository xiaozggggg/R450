...
typedef struct {
    ...
    td_u32  histogram_mem_array_ir[OT_ISP_HIST_NUM]; /* only support fe0  not support for Hi3519DV500 */
} ot_isp_fe_ae_stat_1;
...
typedef struct {
    td_u16  zone_avg[OT_ISP_MAX_STITCH_NUM][OT_ISP_AE_ZONE_ROW][OT_ISP_AE_ZONE_COLUMN][OT_ISP_BAYER_CHN_NUM];
...
typedef struct {
    ...
    td_u32  isp_dgain;          /* R; Range:[0x400, 0xFFFFFFFF]; Format:22.10; */
...
typedef struct {
    td_u16      clip; /* [1, 4096] */
    td_u8       fusion_ratio;    /* [0, 100] */
    td_u16      fusion_curve_value[OT_ISP_GAMMA_NODE_NUM];
