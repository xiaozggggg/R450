...
#define OT_ISP_MAX_FE_PIPE_NUM                    4
#define OT_ISP_MAX_PHY_PIPE_NUM                   7  // 4 + 3, 3 is no fe pipe
#define OT_ISP_MAX_VIR_PIPE_NUM                   8
#define OT_ISP_MAX_PIPE_NUM                       (OT_ISP_MAX_PHY_PIPE_NUM + OT_ISP_MAX_VIR_PIPE_NUM)
#define OT_ISP_MAX_STITCH_NUM                     OT_ISP_MAX_FE_PIPE_NUM

#define OT_ISP_SENSOR_WIDTH_MAX                   8192
#define OT_ISP_SENSOR_HEIGHT_MAX                  8192
#define OT_ISP_RES_WIDTH_MAX                      8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, \
                                                    8192, 8192, 8192, 8192
#define OT_ISP_RES_HEIGHT_MAX                     8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, 8192, \
                                                    8192, 8192, 8192, 8192
...
#define ot_isp_lsc_xgrid_width_max(x)             255
#define ot_isp_lsc_ygrid_width_max(x)             255
